...
#include "TiledImageOutputWindow.h"
#include "TileCommandlineParser.h"
...
TiledImageOutputWindow<Precision> * outputBuffer = NULL;
TileCommandlineParser * options = NULL;
...
{
  // Necessary for some OSes
  Magick::InitializeMagick(*argv);

  options = new TileCommandlineParser(argc, argv);
  ...
  size_t bufferingInput = StreamedImagePrescaledInputWindow<Precision>::bufferSize(options->srcWidth,
                                                                                   ...
                                                                                   (void *) charRow,
                                                                                   0)
                          + TiledImageOutputWindow<Precision>::bufferSize(options->cropWidth,
                                                                          options->cropHeight,
                                                                          options->tileWidth,
                                                                          options->tileHeight,
                                                                          0,
                                                                          ...
                                                                          0,
                                                                          true);
  size_t bufferingOutput = TiledImageOutputWindow<Precision>::bufferSize(options->cropWidth,
                                                                         options->cropHeight,
                                                                         options->tileWidth,
                                                                         options->tileHeight,
                                                                         radiusY,
  ...
  else
  {
    bufferingInput = StreamedImagePrescaledInputWindow<Precision>::bufferSize(options->srcWidth,
                     ...
                     + TiledImageOutputWindow<Precision>::bufferSize(options->cropWidth,
                                                                     ...
                                                                     0,
                                                                     false);
    bufferingOutput = TiledImageOutputWindow<Precision>::bufferSize(options->cropWidth,
                                                                    options->cropHeight,
                                                                    options->tileWidth,
                                                                    options->tileHeight,
                                                                    radiusY,
  ...
  size_t outputBufferLineCost = TiledImageOutputWindow<Precision>::lineSize(options->cropWidth, d, normalized);
  if (bufferInputWindow)
  {
    ...
    outputBuffer = new TiledImageOutputWindow<Precision>(options->cropWidth,
                                                         options->cropHeight,
                                                         options->tileWidth,
                                                         options->tileHeight,
                                                         0,
