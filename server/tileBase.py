  ...
  class SelectVisible(SelectBase):
    def __init__(self, uid=None, tail=None):
      ...
      if uid == None:
        ...
        #             SELECT iid
        #             FROM images
        #             WHERE status > %d AND (public_image_view OR
        #                                    public_image_annotate OR
        #                                    public_image_outline)
        #                OR status >= %d AND public_image_edit
        ...
        #self.query = """
        #             SELECT iid
        #             FROM images LEFT JOIN image_privileges_cache USING (iid)
        #             WHERE status > %d AND (public_image_view OR
        #                                    public_image_annotate OR
        #                                    public_image_outline OR
        #                                    uid = %d)
        #                OR status >= %d AND (public_image_edit OR
        #                                     owner = %d OR
        #                                     uid = %d AND image_edit)
...
if __name__ == '__main__':
  ...
  tb = TileBase(db, tileDir, sourceDir)
