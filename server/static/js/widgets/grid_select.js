    ...
    restart: function(x, y) {
        ...
        floatView.mouseleave(leave)
                .mouseup(function(evt) {
                    grid_view_this.options.callback(grid_view_this.currentPos.x, grid_view_this.currentPos.y);
